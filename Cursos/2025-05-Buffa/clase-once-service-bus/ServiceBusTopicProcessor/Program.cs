...
Console.WriteLine("Ingrese el nombre del topic:");
string queueName = Console.ReadLine()!;

Console.WriteLine("Ingrese el nombre de la suscripción:");
string subscriptionName = Console.ReadLine()!;

Console.WriteLine("Iniciando el procesador de mensajes...");

ServiceBusClient client = new ServiceBusClient(connectionString);
ServiceBusProcessor processor = client.CreateProcessor(queueName, subscriptionName);
