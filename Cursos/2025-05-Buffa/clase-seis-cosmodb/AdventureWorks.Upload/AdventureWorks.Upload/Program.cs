namespace AdventureWorks.Upload
{
    ...
    public class Program
    {
        ...
        private const string JsonFilePath = @"C:\Cursos\Az-204\Cursos\2025-05-Buffa\clase-seis-cosmodb\AdventureWorks.Upload\AdventureWorks.Upload\models.json";
        ...
        {
            Console.WriteLine("Ingrese Endpoint URL de CosmoDB:");
            string EndpointUrl = Console.ReadLine()!;
            Console.WriteLine("Ingrese La Key de CosmoDB:");
